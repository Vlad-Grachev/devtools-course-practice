...
0: Print Help
1: Enter salary per hour + value
2: Set the number of hours worked by the employee, + value
3: Set the cost of an hour of work over the plan, + value
4: Set the number of days off, + value
5: Set the number of hours according to the plan for this employee, + value
6: Set the length of the working day, + value
7: The output of the calculated salary, + any number (it does not matter)
